...
//            @NotNull Db1_RaillyLinkerCompany_TotalAuthMember_Repository db1TemplateTestDataRepository,
...
//            @NotNull Db1_RaillyLinkerCompany_TotalAuthMember_RepositoryDsl db1TemplateFkTestManyToOneChildRepositoryDsl,
...
//    private final @NotNull Db1_RaillyLinkerCompany_TotalAuthMember_Repository db1TemplateTestDataRepository;
...
//    private final @NotNull Db1_RaillyLinkerCompany_TotalAuthMember_RepositoryDsl db1TemplateFkTestManyToOneChildRepositoryDsl;
...
//    ) {
//        @NotNull Db1_RaillyLinkerCompany_TotalAuthMember result = db1TemplateTestDataRepository.save(
//                Db1_RaillyLinkerCompany_TotalAuthMember.builder()
...
//    ) {
//        if (deleteLogically) {
//            @NotNull List<Db1_RaillyLinkerCompany_TotalAuthMember> entityList = db1TemplateTestDataRepository.findAllByRowDeleteDateStrOrderByRowCreateDate("/");
//            for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMember entity : entityList) {
...
//            @NotNull Boolean deleteLogically
//    ) {
//        @Nullable Db1_RaillyLinkerCompany_TotalAuthMember entity = db1TemplateTestDataRepository.findByUidAndRowDeleteDateStr(index, "/");
//
//        if (entity == null) {
...
//            @NotNull HttpServletResponse httpServletResponse
//    ) {
//        @NotNull List<Db1_RaillyLinkerCompany_TotalAuthMember> resultEntityList =
...
//        for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMember resultEntity : resultEntityList) {
...
//        }
//
//        @NotNull List<Db1_RaillyLinkerCompany_TotalAuthMember> logicalDeleteEntityVoList =
...
//        for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMember resultEntity : logicalDeleteEntityVoList) {
...
//            @NotNull Integer num
//    ) {
//        @NotNull List<Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindAllFromTemplateTestDataByNotDeletedWithRandomNumDistanceOutputVo> foundEntityList =
...
//                new ArrayList<>();
//
//        for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindAllFromTemplateTestDataByNotDeletedWithRandomNumDistanceOutputVo entity : foundEntityList) {
...
//    ) {
//        @NotNull List<Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindAllFromTemplateTestDataByNotDeletedWithRowCreateDateDistanceOutputVo> foundEntityList =
...
//                new ArrayList<>();
//
//        for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindAllFromTemplateTestDataByNotDeletedWithRowCreateDateDistanceOutputVo entity : foundEntityList) {
//            testEntityVoList.add(
...
//        @NotNull Page<Db1_RaillyLinkerCompany_TotalAuthMember> entityList =
//                db1TemplateTestDataRepository.findAllByRowDeleteDateStrOrderByRowCreateDate(
//                        "/",
//                        pageable
//                );
...
//    ) {
//        @NotNull Pageable pageable = PageRequest.of(page - 1, pageElementsCount);
//        @NotNull Page<Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindPageAllFromTemplateTestDataByNotDeletedWithRandomNumDistanceOutputVo> voList =
...
//        for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindPageAllFromTemplateTestDataByNotDeletedWithRandomNumDistanceOutputVo vo : voList) {
...
//    ) {
//        @Nullable Db1_RaillyLinkerCompany_TotalAuthMember oldEntity = db1TemplateTestDataRepository.findByUidAndRowDeleteDateStr(testTableUid, "/");
//
//        if (oldEntity == null) {
//            httpServletResponse.setStatus(HttpStatus.NO_CONTENT.value());
//            httpServletResponse.setHeader("api-result-code", "1");
...
//        );
//
//        @NotNull Db1_RaillyLinkerCompany_TotalAuthMember result = db1TemplateTestDataRepository.save(oldEntity);
//
//        httpServletResponse.setStatus(HttpStatus.OK.value());
...
//    ) {
//        @NotNull Pageable pageable = PageRequest.of(page - 1, pageElementsCount);
//        @NotNull Page<Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindPageAllFromTemplateTestDataBySearchKeywordOutputVo> voList =
...
//        for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindPageAllFromTemplateTestDataBySearchKeywordOutputVo vo : voList) {
//            testEntityVoList.add(
...
//    ) {
//        // 중복 없는 페이징 쿼리를 사용합니다.
//        @NotNull List<Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindAllFromTemplateTestDataForNoDuplicatedPagingOutputVo> voList =
...
//        for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindAllFromTemplateTestDataForNoDuplicatedPagingOutputVo vo : voList) {
...
//            @NotNull Long testTableUid
//    ) {
//        @Nullable Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindFromTemplateTestDataByNotDeletedAndUidOutputVo entity =
...
//
//        @NotNull Db1_RaillyLinkerCompany_TotalAuthMemberEmail result =
//                db1TemplateFkTestManyToOneChildRepository.save(
//                        Db1_RaillyLinkerCompany_TotalAuthMemberEmail.builder()
...
//                    new ArrayList<>();
//
//            @NotNull List<Db1_RaillyLinkerCompany_TotalAuthMemberEmail> childList =
//                    db1TemplateFkTestManyToOneChildRepository.findAllByFkTestParentAndRowDeleteDateStrOrderByRowCreateDate(
//                            resultEntity,
//                            "/"
//                    );
//
//            for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMemberEmail childEntity : childList) {
...
//        @NotNull List<Db1_RaillyLinkerCompany_TotalAuthMember> jpaRepositoryResultEntityList =
...
//                new ArrayList<>();
//        for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMember jpaRepositoryResultEntity : jpaRepositoryResultEntityList) {
...
//
//        // JPQL : Injection Safe
//        @NotNull List<Db1_RaillyLinkerCompany_TotalAuthMember> jpqlResultEntityList =
...
//                new ArrayList<>();
//        for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMember jpqlEntity : jpqlResultEntityList) {
//            jpqlResultList.add(
//                    new JpaTestController.SqlInjectionTestOutputVo.TestEntityVo(
//                            jpqlEntity.getUid(),
...
//        @NotNull List<Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindAllFromTemplateTestDataByContentOutputVo> nativeQueryResultEntityList =
...
//                new ArrayList<>();
//        for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMember_Repository.FindAllFromTemplateTestDataByContentOutputVo nativeQueryEntity : nativeQueryResultEntityList) {
...
//                    new ArrayList<>();
//
//            for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMemberEmail childEntity : resultEntity.getFkTestManyToOneChildList()) {
//                childEntityVoList.add(
...
//            @NotNull Long parentUid
//    ) {
//        @NotNull List<Db1_RaillyLinkerCompany_TotalAuthMemberEmail> resultEntityList =
...
//                new ArrayList<>();
//
//        for (@NotNull Db1_RaillyLinkerCompany_TotalAuthMemberEmail resultEntity : resultEntityList) {
//            entityVoList.add(
...
//            @NotNull Long index
//    ) {
//        @NotNull Optional<Db1_RaillyLinkerCompany_TotalAuthMemberEmail> entityOpt =
